...
export default function ProfileSettings({ onLogout }: { onLogout: () => void }) {
  ...
  if (!user) return <div className="text-center mt-10 text-gray-500">유저 정보를 불러오는 중...</div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                    <div className="flex-1 px-3 py-2 bg-gray-50 rounded-lg text-gray-800">{user.name}</div>
              </div>
            </div>
